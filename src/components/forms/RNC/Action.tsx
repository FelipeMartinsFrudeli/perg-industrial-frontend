...
function Action() {
    ...
    return (
        <>
            <p className="col-span-6 align-middle h-5.5">Há produtos ou processo que necessite estender a ação de conteção?</p>
            ...
            {showContentReason && (
                <>
                     <InputField name="atualizado" label="Se sim, quais?" placeholder="Quais foram?" className="col-span-12"/>
